        ...
        <div class="am-container" style="position:relative;">
            <div style="display:flex;align-items:center;gap:28px;flex-wrap:wrap;">
                ...
                <div style="flex:1;min-width:0;">
                    <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin-bottom:10px;">
                        <x-badge tone="gold" variant="solid" size="md">SDIT</x-badge>
                    ...
                    <p style="font-family:var(--font-sans);font-size:var(--text-md);color:var(--gold-200);margin:0;opacity:.9;">
                        Sekolah Dasar Islam Terpadu · {{ $school->address ? 'Kota Bekasi' : 'Kota Bekasi' }}
                    </p>
                </div>
            </div>
            ...
            <div style="display:flex;gap:32px;flex-wrap:wrap;margin-top:36px;padding-top:28px;border-top:1px solid rgba(255,255,255,.15);">
                ...
                <div>
                    ...
                    <div style="font-family:var(--font-sans);font-size:var(--text-sm);color:#FBF8F1;">7–12 tahun (Kelas 1–6)</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <section class="am-section" style="background:var(--surface-page);">
            <div class="am-container">
                <div class="am-grid-2" style="gap:28px;">
                    ...
                    @if($school->mission)
                        <div class="am-reveal am-card" style="padding:32px;border-left:4px solid var(--gold-400);" x-reveal-delay="80">
                            <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
                                <div style="width:36px;height:36px;background:var(--gold-50,var(--cream-100));border-radius:var(--radius-md);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
        ...
        <section class="am-section" style="background:var(--surface-card);">
            <div class="am-container">
                <div class="am-reveal" style="display:flex;align-items:flex-end;justify-content:space-between;gap:24px;flex-wrap:wrap;margin-bottom:32px;">
                    <x-section-header eyebrow="Kabar SDIT" title="Berita Terbaru" />
                    <a href="{{ route('berita.index', ['jenjang' => 'sdit']) }}" class="am-btn am-btn--outline am-btn--sm">
                        Lihat Semua →
                    </a>
                </div>
                <div class="am-grid-3">
